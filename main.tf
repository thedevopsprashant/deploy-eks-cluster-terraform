...
module "vpc" {
  source = "github.com/thedevopsprashant/terraform-aws-modules//modules/vpc?ref=v1.1.4"
...
module "eks" {
  source = "github.com/thedevopsprashant/terraform-aws-modules//modules/eks?ref=v1.1.4"
...
module "helm" {
  source = "github.com/thedevopsprashant/terraform-aws-modules//modules/helm?ref=v1.1.4"
